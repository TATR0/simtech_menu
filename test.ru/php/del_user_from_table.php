...
<body>
	<style>
		...
		<div align="center" style="margin-top: 150px;" class="col">
			<h1 style="margin-bottom: 50px;">Удаление сотрудника из таблицы </h1 >
				<form action="del_user.php" class="forma" method="post">

					<input type="text" class="form-control" name="yid"  placeholder="Введите id сотрудника"><br>					
